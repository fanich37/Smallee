...
(function (root, factory) {
  ...
  Smallee.prototype.init = function () {
    ...
    var fragment = build.call(this, this.settings.effect);
  ...
  Smallee.prototype.destroy = function () {
    ...
    slides.forEach(function (item) {
      ...
      _this3.selector.appendChild(item);
    });
  };
   ...
   */
  var prevDefAndStopProp = function prevDefAndStopProp(event) {
    event.preventDefault();
    event.stopPropagation();
  };

  var mergeSettings = function mergeSettings(defaultSettings, userSettings) {
  ...
  var build = function build(effectType) {
    var _this4 = this;
  ...
  var setData = function setData() {
    ...
    switch (this.settings.effect) {
      case 'slide':
      default:
        var sliderWidth = this.selector.scrollWidth;
  ...
  var setArrowsState = function setArrowsState() {
  ...
  var defineSmalleeWasTranslatedOn = function defineSmalleeWasTranslatedOn() {
  ...
  var restoreTransition = function restoreTransition() {
    this.track.style.transition = this.settings.transition;
  };
  ...
  var mouseMove = function mouseMove(event) {
    if (this.isDown && this.settings.effect !== 'fade') {
      this.track.style.transform = 'translate3d(' + (this.instanceData.wasMovedOn + event.clientX - this.instanceData.start) + 'px, 0, 0)';
    }
  };
  ...
  var preventDragStart = function preventDragStart(event) {
   ...
   * Events
   */
  var initClickEvents = function initClickEvents() {
    this.selector.addEventListener('click', this.bindGetDirection);
  };

  var removeClickEvents = function removeClickEvents() {
    this.selector.removeEventListener('click', this.bindGetDirection);
  };

  var initSwipeEvents = function initSwipeEvents() {
  ...
  var removeSwipeEvents = function removeSwipeEvents() {
  ...
  var resizeHandler = function resizeHandler() {
    ...
    var timer = setTimeout(function () {
      if (_this6.instanceData.resized) {
        clearTimeout(timer);
        _this6.refresh();
        _this6.instanceData.resized = false;
      }
