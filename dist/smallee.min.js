...
;(function (root, factory) {
	...
	function Smallee(object) {
		...
		['changeSlide', 'moveSlides', 'mouseDown', 'mouseUp', 'mouseMove', 'mouseLeave', 'preventDragStart'].forEach(function (method) {
	...
	Smallee.prototype.setStylesToTheElements = function () {
		...
		switch (this.settings.effect) {
			case 'fade':
				this.slides.forEach(function (item, i) {
					item.style.transition = _this4.settings.transition;
				});
				break;
			default:
